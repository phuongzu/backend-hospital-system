...
class EmailService {
  ...
  async sendVerificationCode(to: string, code: string, name: string): Promise<void> {
    ...
    const mailOptions = {
      ...
      to: to,
      subject: 'Password Reset Verification Code - MedCare',
    ...
    return `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>&copy; 2024 MedCare Healthcare. All rights reserved.</p>
      ...
      const html = `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>This is an automated message from MedCare Healthcare. Please do not reply to this email.</p>
              <p>© ${new Date().getFullYear()} MedCare Healthcare. All rights reserved.</p>
            </div>
          </div>
        </body>
        </html>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="footer">
                <p>This consultation summary was generated by MedCare Healthcare.</p>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="footer">
                <p>This is an automated confirmation from MedCare Healthcare.</p>
                <p>© ${new Date().getFullYear()} MedCare Healthcare. All rights reserved.</p>
              </div>
            </div>
          </div>
  ...
  async sendUnlockRequestConfirmation(
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'MedCare - Account Unlock Request Received',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Hello Dr. ${name},</p>
              <p>We have received your request to unlock your MedCare account.</p>
            ...
            <div class="footer">
              <p>Best regards,<br>MedCare Support Team</p>
              <p>&copy; 2024 MedCare Healthcare. All rights reserved.</p>
            </div>
          </div>
        </body>
  ...
  async sendUnlockRequestToAdmin(
    ...
    const mailOptions = {
      from: {
        name: 'MedCare Healthcare System',
        address: 'pvu7999@gmail.com'
      },
      to: adminEmail,
      subject: `MedCare - New Account Unlock Request from Dr. ${doctorName}`,
      html: `
        <!DOCTYPE html>
        <html>
        <head>
  ...
  async sendAccountUnlockedNotification(
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'MedCare - Your Account Has Been Unlocked',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>✅ MedCare Account Unlocked</h1>
            </div>
            <div class="content">
              ...
              <div class="success-box">
                <p style="margin: 0; color: #155724;"><strong>Your MedCare account has been successfully unlocked!</strong></p>
              </div>
  ...
  async sendDoctorApprovalEmail(
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Doctor Registration Approved - MedCare System',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <h2>Welcome to MedCare System!</h2>
              <p>Dear Dr. ${name},</p>
              <p>Your doctor registration has been approved by our administration team.</p>
              <p>You can now login to the MedCare system using the following credentials:</p>
            ...
            <div class="footer">
              <p>Best regards,<br>MedCare Administration Team</p>
              <p>&copy; 2024 MedCare Healthcare. All rights reserved.</p>
            </div>
          </div>
        </body>
  ...
  async sendDoctorRejectionEmail(
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Doctor Registration Update - MedCare System',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Dear ${name},</p>
              <p>Thank you for your interest in joining the MedCare system.</p>
  ...
  async sendRegistrationConfirmation(
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Doctor Registration Received - MedCare System',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Dear ${name},</p>
              <p>Thank you for submitting your doctor registration to the MedCare system.</p>
      ...
      const html = `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>This is an automated notification from MedCare Healthcare.</p>
              <p>© ${new Date().getFullYear()} MedCare Healthcare. All rights reserved.</p>
            </div>
          </div>
        </body>
