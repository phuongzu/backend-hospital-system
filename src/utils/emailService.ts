          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <ul>
                ...
                <li>📧 Email: support@medpro.com</li>
                <li>💬 Chat: Available in your patient portal</li>
              </ul>
            </div>
            
            <div class="footer">
              <p>This is an automated message from MedPro Healthcare. Please do not reply to this email.</p>
              <p>© ${new Date().getFullYear()} MedPro Healthcare. All rights reserved.</p>
            </div>
          </div>
        </body>
        </html>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="footer">
                <p>This consultation summary was generated by MedPro Healthcare.</p>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="footer">
                <p>This is an automated confirmation from MedPro Healthcare.</p>
                <p>© ${new Date().getFullYear()} MedPro Healthcare. All rights reserved.</p>
              </div>
            </div>
          </div>
      ...
      const html = `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>This is an automated notification from MedPro Healthcare.</p>
              <p>© ${new Date().getFullYear()} MedPro Healthcare. All rights reserved.</p>
            </div>
          </div>
        </body>
